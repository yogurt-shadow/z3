...
(let ((.def_388 (and .def_105 .def_117)))
(let ((.def_112 (not b.counter.2__AT1)))
(let ((.def_389 (and .def_112 .def_388)))
(let ((.def_127 (not b.counter.3__AT1)))
(let ((.def_390 (and .def_127 .def_389)))
(let ((.def_385 (and .def_60 .def_384)))
(let ((.def_381 (not b.EVENT.0__AT2)))
(let ((.def_379 (not b.EVENT.1__AT2)))
(let ((.def_382 (or .def_379 .def_381)))
(let ((.def_6 (not b.counter.0__AT2)))
(let ((.def_4 (not b.counter.1__AT2)))
(let ((.def_372 (or .def_4 .def_6)))
(let ((.def_376 (or b.counter.3__AT2 .def_372)))
(let ((.def_373 (or b.counter.2__AT2 .def_372)))
(let ((.def_9 (not b.counter.2__AT2)))
(let ((.def_371 (or .def_6 .def_9)))
(let ((.def_374 (and .def_371 .def_373)))
(let ((.def_12 (not b.counter.3__AT2)))
(let ((.def_375 (or .def_12 .def_374)))
...
(let ((.def_313 (and .def_224 .def_226)))
(let ((.def_317 (not .def_313)))
(let ((.def_367 (or .def_317 .def_366)))
...
(let ((.def_344 (and .def_299 .def_311)))
(let ((.def_341 (= b.delta__AT1 0.0 )))
(let ((.def_342 (and .def_313 .def_341)))
...
(let ((.def_323 (= b.time__AT1 b.time__AT2)))
(let ((.def_335 (and .def_311 .def_323)))
(let ((.def_336 (and .def_299 .def_335)))
(let ((.def_337 (and .def_306 .def_336)))
(let ((.def_338 (or .def_224 .def_337)))
(let ((.def_326 (* (- 1.0) b.time__AT2)))
(let ((.def_329 (+ b.delta__AT1 .def_326)))
(let ((.def_330 (+ b.time__AT1 .def_329)))
(let ((.def_331 (= .def_330 0.0 )))
(let ((.def_332 (or .def_317 .def_331)))
(let ((.def_333 (or b.EVENT.1__AT1 .def_332)))
(let ((.def_324 (or .def_313 .def_323)))
(let ((.def_325 (or b.EVENT.1__AT1 .def_324)))
(let ((.def_334 (and .def_325 .def_333)))
(let ((.def_339 (and .def_334 .def_338)))
(let ((.def_319 (= .def_317 b.event_is_timed__AT2)))
(let ((.def_316 (= b.event_is_timed__AT1 .def_313)))
...
(let ((.def_315 (or b.EVENT.1__AT1 .def_314)))
...
(let ((.def_392 (and .def_259 .def_391)))
(let ((.def_417 (and .def_392 .def_416)))
.def_417)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
