...
(declare-fun v () Real)
(assert
 (let ((?x91 (+ (* (* (- (/ 11.0 100.0)) u!) v!) (+ (* (* (/ 3.0 50.0) v!) v!) (* (- 1.0) u!)))))
 (let ((?x264 (* (/ 1.0 4.0) v!)))
 (let (($x34 (and (<= (- (/ 7.0 10.0)) u!) (>= (/ 21.0 10.0) u!) (<= (- 7.0) v!) (>= 3.0 v!))))
 (let (($x8 (and $x34 (>= (/ 34.0 25.0) (+ ?x264 (+ (* (* (/ 83.0 100.0) u!) u!) ?x91))) )))
 (let (($x53 (and (= u! (+ u (* (/ 1.0 100.0) v))) (= v! (+ v (* (/ 1.0 100.0) (- (* (- (/ 1.0 2.0)) v) (* (/ 981.0 100.0) u))))))))
 (let ((?x246 (+ (* (* (- (/ 11.0 100.0)) u) v) (+ (* (* (/ 3.0 50.0) v) v) (* (- 1.0) u)))))
 (let (($x70 (>= 3.0 v)))
 (let (($x295 (and (and (<= (- (/ 7.0 10.0)) u) (>= (/ 21.0 10.0) u) (<= (- 7.0) v) $x70) (>= (/ 34.0 25.0) (+ (* (/ 1.0 4.0) v) (+ (* (* (/ 83.0 100.0) u) u) ?x246))) )))
 (and $x295 $x53 (not $x8)))))))))))
(check-sat)
(exit)
