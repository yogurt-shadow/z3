...
(declare-fun v () Real)
(assert
 (let ((?x151 (+ (* (* (/ 3.0 100.0) u!) v!) (+ (* (* (/ 9.0 100.0) v!) v!) (* (/ 1.0 100.0) u!)))))
 (let ((?x147 (* (/ 3.0 100.0) v!)))
 (let (($x121 (and (<= (- 1.0) u!) (>= 1.0 u!) (<= (- (/ 7.0 2.0)) v!) (>= (/ 31.0 10.0) v!))))
 (let (($x152 (and $x121 (>= (/ 49.0 50.0) (+ ?x147 (+ (* (* 1.0 u!) u!) ?x151))) )))
 (let (($x156 (and (= u! (+ u (* (/ 1.0 100.0) v))) (= v! (+ v (* (/ 1.0 100.0) (- (* (- (/ 1.0 2.0)) v) (* (/ 981.0 100.0) u))))))))
 (let ((?x18 (+ (* (* (/ 3.0 100.0) u) v) (+ (* (* (/ 9.0 100.0) v) v) (* (/ 1.0 100.0) u)))))
 (let ((?x271 (* (/ 3.0 100.0) v)))
 (let (($x101 (and (<= (- 1.0) u) (>= 1.0 u) (<= (- (/ 7.0 2.0)) v) (>= (/ 31.0 10.0) v))))
 (let (($x7 (and $x101 (>= (/ 49.0 50.0) (+ ?x271 (+ (* (* 1.0 u) u) ?x18))) )))
 (and $x7 $x156 (not $x152))))))))))))
(check-sat)
(exit)
