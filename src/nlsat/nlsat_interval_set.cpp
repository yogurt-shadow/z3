...
#define MAX_RANDOM_DEN_K 4
    ...
    void interval_set_manager::push_boundary(vector<anum_boundary> & boundaries, anum const & val, bool is_open, int inc_score, clause_index c_idx) {
    ...
    void interval_set_manager::add_boundaries(interval_set const * s, vector<anum_boundary> & boundaries, int & start_score, int weight, clause_index c_idx) {
