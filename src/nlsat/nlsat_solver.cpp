...
namespace nlsat {
    ...
    struct solver::imp {
        ...
        imp(solver& s, ctx& c):
            ...
            // wzh ls
            m_lsh(s, m_am, m_pm, m_cache, m_ism, m_evaluator, m_assignment, m_clauses, m_atoms, m_dead, m_random_seed, m_ls_step, m_ls_stuck, m_ls_stuck_ratio, m_cad_move, m_cad_succeed, m_poly_bound, m_ls_pair_cm, m_sub_values),
            // hzw ls
            m_scope_lvl(0),
            m_lemma(s),
            m_lazy_clause(s),
        ...
        */
        ...
        void init_search() {
            ...
            m_num_pure_bool_vars = 0;
            for(bool_var b = 0; b < m_atoms.size(); b++){
                if(m_atoms[b] == nullptr){
                    m_num_pure_bool_vars++;
                }
            }
        }
        ...
        */
        ...
        void collect_statistics(statistics & st) {
            ...
            st.update("nlsat bool vars", m_num_pure_bool_vars);
            // basic
        }
